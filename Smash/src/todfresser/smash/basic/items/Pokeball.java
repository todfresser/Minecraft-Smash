...
import todfresser.smash.basic.mobs.main.SmashEntityType;
...
public class Pokeball extends SmashItem{
	...
	public boolean onRightClickEvent(SmashPlayerData playerdata, Player player, Game game) {
		Item pokeball = player.getWorld().dropItem(player.getEyeLocation(), new ItemStack(Material.LEGACY_MONSTER_EGG));
