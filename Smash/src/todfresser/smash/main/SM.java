...
public enum SM {
	...
	Command_Help_0("Commands.help.0", "§6<<§9------------------------§6>>"),
	...
	Command_Help_Admin_0("Commands.help.admin.0", "§6<<§9------------------------§6>>"),
	Command_Help_Admin_1("Commands.help.admin.1", "/smash start Sofortiges Starten einen Spiels."),
	Command_Help_Admin_2("Commands.help.admin.2", "/smash admin edit Erstellen/Verändern einer Map."),
	...
	Command_Help_Admin_6("Commands.help.admin.6", "/smash admin maps Anzeigen aller Maps."),
	Command_Help_Admin_7("Commands.help.admin.7", "/smash admin games Anzeigen aller laufenden Spiele."),
	Command_Help_Admin_8("Commands.help.admin.8", "/smash admin goto Teleportieren zu einer existierenden Map."),
	Command_Help_Admin_9("Commands.help.admin.9", "§6<<§9------------------------§6>>"),
