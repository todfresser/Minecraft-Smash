...
public enum SM {
	...
	Command_Stats_6("Commands.stats.show.6", "§6>§9Schaden ausgeteilt: §6"),
	Command_Stats_7("Commands.stats.show.7", "§6>§9Erhaltener Schaden: §6"),
	Command_Stats_8("Commands.stats.show.8", "§6<<§9------------------------§6>>"),
