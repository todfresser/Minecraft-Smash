...
public enum SM {
	...
	Command_Help_Admin_6("Commands.help.admin.6", "/smash maps Anzeigen aller Maps."),
	Command_Help_Admin_7("Commands.help.admin.7", "/smash games Anzeigen aller laufenden Spiele."),
